...
.. module:: doctest
   ...
   :synopsis: A test to see if I can get a module's contents into sphinx's generated documentation

.. moduleauthor:: Drew Blount <dblount@reed.edu>

"""

def public_fn_with_sphinxy_docstring(test_param, state=None):
    """This function does little.

    :param test_param: just checking.
    :type test_param: str.
...
# copied from sphinx documentation
