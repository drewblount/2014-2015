...
def sample_test():
    ...
    obj_F = sinusoparaboloid(1,1,2.5,sin_strength=0.25)

    test = smb_optimizer(domain, obj_F, dace_function,brute_optimize_EI=True)
    ...
    test.take_samples(0.01,20,plot_dims=0)
