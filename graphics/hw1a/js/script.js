...
function drawScene() {
    ...
    mat4.translate(mvMatrix, [-1, 0.0, -8.0]);
    mvPushMatrix();
    mat4.rotate(mvMatrix, degToRad(r1), [0, 1, 0]);
	// note that cubit is a global Shape var defined in shape.js
	cubit.drawShape(gl);
	// the push/pop allows me not to reset after each cube's rotation
    mvPopMatrix();
    ...
    mat4.translate(mvMatrix, [2.0, 0.0, -10.0]);
    mvPushMatrix();
    mat4.rotate(mvMatrix, degToRad(r3), [0, 1, 1]);
	cubit.drawShape(gl);
    mvPopMatrix();
